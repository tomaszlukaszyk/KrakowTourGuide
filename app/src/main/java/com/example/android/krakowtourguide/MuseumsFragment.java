...
public class MuseumsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        String[] cardTitle = getResources().getStringArray(R.array.museums_title);
        // Get the text for body of every card from array resource file and put them in Array object
        String[] cardBody = getResources().getStringArray(R.array.museums_body);
        // Get the resource ID of images for cards from array resource file and put them in TypedArray object
        final TypedArray cardImage = getResources().obtainTypedArray(R.array.museums_image);
